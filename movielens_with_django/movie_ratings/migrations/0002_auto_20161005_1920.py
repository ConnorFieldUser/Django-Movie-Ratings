# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-10-05 19:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='data',
            name='item_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movie_ratings.Item'),
        ),
        migrations.AddField(
            model_name='data',
            name='rater_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movie_ratings.Rater'),
        ),
    ]
